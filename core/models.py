...
from django.db.models import Model, CharField, IntegerField, EmailField, ForeignKey, \
    ...
    PositiveSmallIntegerField, ImageField  # doplnit postupne podle vsech modelu
...
class Book(models.Model):
    ...
    thumbnail = ImageField(upload_to='static/images/thumbnail', default='static/images/KK_logo.jpeg')
